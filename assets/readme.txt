New asset structure!
"assets/" => contains base game assets
"assets/shared" => contains only mod assets, also you can add folders like: "assets/shared/videos", "assets/shared/characters" and it could be loaded by game!

Order of loading assets is:
"mods/<modFolder>/" => "mods/" => "assets/<currentLevel>/" => "assets/shared/" => "assets/"
