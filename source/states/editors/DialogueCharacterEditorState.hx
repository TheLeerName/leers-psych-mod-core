...
class DialogueCharacterEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		offsetLoopText.setFormat("VCR OSD Mono", 32, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		animText.setFormat("VCR OSD Mono", 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function reloadCharacter() {
		...
		DiscordClient.changePresence("In the Dialogue Character Editor", "Selected " + character.jsonFile.image);
	}
