...
class NoteSplashEditorState extends MusicBeatState
{
	...
	override function create()
	{
		...
		FlxG.sound.volumeUpKeys.clearArray();
		FlxG.sound.volumeDownKeys.clearArray();
		FlxG.sound.muteKeys.clearArray();
	...
	function onLoadComplete(_):Void
	{
		...
		try 
		{
			...
			{
				try txt = Paths.text(txtLoaded.__path) catch (e) txt = null;
